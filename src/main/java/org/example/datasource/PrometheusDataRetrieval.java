...
public class PrometheusDataRetrieval {
    ...
    public List<ImportDataJsonObject> retrievePrometheusData() {
        ...
        ImportDataJsonObject importData =   createImportDataObject(activeNamespaces, namespaceWorkloadMap);
    ...
    private ImportDataJsonObject createImportDataObject(List<String> activeNamespaces, Map<String, List<Map<String, String>>> namespaceWorkloadMap) {
        ...
        for (String namespaceName : activeNamespaces) {
            ...
            for (Map<String, String> workloadMap : workloadMaps) {
                for (Map.Entry<String, String> entry : workloadMap.entrySet()) {
                    ...
                    workload.setWorkloadName(entry.getKey());
                    workload.setWorkloadType(entry.getValue());
